...
// Funzione per gestire la registrazione audio dall'output del contesto audio
function startRecording() {
    try {
        // Assicurati che lo streamDestination sia inizializzato correttamente
        if (!streamDestination) {
            console.error("streamDestination non è stato inizializzato.");
            return;
        }

        // Usa il MediaStreamDestinationNode come input per il MediaRecorder
